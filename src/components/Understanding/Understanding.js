...
class Understanding extends Component {
    ...
    handleNextClick = event => {
        ...
        if(this.state.understanding_level){
            this.props.dispatch({ type: 'ADD_UNDERSTANDING_LEVEL', payload: Number(this.state.understanding_level) });
    ...
    componentDidMount = () => {
        this.props.dispatch({ type: 'STEPPER_1' });
    }
